...
const DetailDrink = props => {
    ...
    const [link, setLink] = useState("https://lindsaypeeters.com/wp-content/uploads/2023/01/image-11-150x150.png");
    const getDrinksById = async () => {
        try{
          ...
          console.log(title);
          //picture toevoegen
          setPicture(json.rttpg_featured_image_url.thumbnail);
          console.log("picture:");
          console.log(picture);
          setLink(json.rttpg_featured_image_url.thumbnail[0]);
